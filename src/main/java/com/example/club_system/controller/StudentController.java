...
public class StudentController {
	...
	@PostMapping(value = "student/createOrUpdateAll")
	public BasicRes createOrUpdateAll(@Valid @RequestBody StudentcreateOrUpdateReq req) {
		return studentService.createOrUpdateAll(req);
	}
}
